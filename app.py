...
def index():
    if request.method == 'POST':
        ...
        # Subtract years
        start_date_last_year = start_date_dt - relativedelta(years=year_to_subtract, days=days_to_add)
        end_date_last_year = end_date_dt - relativedelta(years=year_to_subtract, days=days_to_add)
        ...
        font-family: "Trebuchet MS", sans-serif;)}
            ...
            <h1><form action= "/" method="get"><button type = "submit"><img src= '/static/header.svg'/></button></form></h1>
